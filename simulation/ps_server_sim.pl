...
# Simulation time
# Note we will all aways add 5000 time units to the sim time and 
# start recording values after 5000 time units have pasted.
# This is to avoid transiant behaviour.
...
print "\n$N jobs completed by 1 server in $T time therefore mean response time is ", $T/$N, "\nNote: Jobs only counted after 5000 time units\n";
